...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Modifier', href: route('magasin.demandes-pieces.edit', props.demande_piece.id_dp) }
];
</script>
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="m-5 mr-2 bg-gray-100 dark:bg-gray-800 rounded-lg">
            ...
            <form @submit.prevent="form.put(route('magasin.demandes-pieces.update', demande_piece.id_dp))" class="m-5">
