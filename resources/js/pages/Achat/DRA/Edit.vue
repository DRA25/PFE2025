...
const form = useForm({
    n_dra: props.dra.n_dra,
    periode: props.dra.periode,
    etat: props.dra.etat,
    cmp_gen: props.dra.cmp_gen,
    cmp_ana: props.dra.cmp_ana,
    debit: props.dra.debit,
    libelle_dra: props.dra.libelle_dra,
    date_dra: props.dra.date_dra,
    fourn_dra: props.dra.fourn_dra,
    destinataire_dra: props.dra.destinataire_dra
});

function submit() {
    form.put(route('dra.update', props.dra.n_dra));
}
</script>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="m-5 bg-gray-100 dark:bg-gray-800 rounded-lg p-6">
            <div class="flex justify-between mb-6">
                <h1 class="text-lg font-bold text-[#042B62FF] dark:text-[#BDBDBDFF]">Modifier DRA</h1>
            </div>
